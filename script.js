...
const translations = {
  zh: {
    ...
    heroDesc: "基于公开呈现，生成第一判断、开场建议、节奏提示与避坑提醒。",
    heroPrimary: "帮我想下一句",
    heroSecondary: "先看一个示例",
    previewKicker: "客户沟通",
    previewTitle: "客户推进指数",
    previewSummary: "",
    previewScoreLabel: "适合低压力推进",
    previewTraitsTitle: "推荐开口",
    previewTagBoundary: "",
    previewTagExpression: "",
    previewTagExposure: "",
    previewTagObserve: "",
    previewDimensionsTitle: "推进信号",
    previewMetricWarmth: "开口自然度",
    previewMetricBoundary: "压力控制度",
    previewMetricOpenness: "推进可行性",
    previewMetricPresentation: "信任建立效率",
    previewMetricFriction: "摩擦控制度",
    previewFrameworkTitle: "下一步接法",
    previewFrameworkBigFive: "",
    previewFrameworkLanguage: "",
    ...
    previewRisk: "风险提醒：不要直接催对方立刻表态，避免增加决策压力。",
  ...
  en: {
    ...
    heroDesc: "Generate a first read, opening suggestion, pacing cues, and risk alerts from public-facing signals.",
    heroPrimary: "Find My Next Line",
    heroSecondary: "View Example",
    previewKicker: "CLIENT COMMUNICATION",
    previewTitle: "Client Momentum Index",
    previewSummary: "",
    previewScoreLabel: "Good for low-pressure follow-up",
    ...
    previewTagExposure: "",
    previewTagObserve: "",
    previewDimensionsTitle: "Momentum Signals",
    previewMetricWarmth: "Opening Naturalness",
    previewMetricBoundary: "Pressure Control",
    previewMetricOpenness: "Momentum Potential",
    previewMetricPresentation: "Trust Building",
    previewMetricFriction: "Friction Control",
    ...
    previewRisk: "Risk alert: do not ask for an immediate decision; it may increase decision pressure.",
