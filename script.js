...
const translations = {
  zh: {
    ...
    heroTitleLine1: "看懂第一印象，",
    heroTitleLine2: "写好下一句话。",
    heroDesc: "上传一张照片，生成开场建议、沟通节奏和避坑提醒。",
    heroPrimary: "帮我想下一句",
    heroSecondary: "先看一个示例",
    previewKicker: "示例预览",
    previewTitle: "客户沟通",
    previewSummary: "第一判断：先降低对方的决策压力，再给一个明确、轻量的下一步。",
    previewTraitsTitle: "推荐开口",
    previewTagBoundary: "“我先不急着推进，主要想把最关键的可选方案和风险点帮您理清，您方便的时候我用 10 分钟过一下就行。”",
    ...
    previewFrameworkLanguage: "如果对方说“最近忙”，可以回：“理解，那我先不占您时间。我只发一条最相关的，您方便的时候看一眼就好。”",
    previewFrameworkPresentation: "",
    previewFrameworkAvatar: "",
    previewFrameworkSocial: "沟通建议",
    previewCurrentReadTitle: "当前判断",
    previewCurrentRead: "适合低压力推进，不建议直接催决策，更适合先给对方一个明确、低成本的下一步。",
    previewStrategyTitle: "推荐策略",
    previewStrategy: "先给价值，再给一个小动作。",
    previewOpenerTitle: "推荐开口",
    previewOpener: "“我先不急着推进，主要想把两个最关键的可选方案和风险点帮您理清，您方便的时候我用 10 分钟过一下就行。”",
    previewNextMoveTitle: "下一步动作",
    previewNextMove1: "先发一条低打扰消息",
    previewNextMove2: "给出一个明确但轻量的下一步",
    previewNextMove3: "留出对方回复空间",
    previewRisk: "避坑提醒：不要直接催对方立刻表态。",
    ...
    avatarUploadDesc: "一张清晰照片，即可开始分析。",
  ...
  en: {
    ...
    heroTitleLine2: "Shape the next line.",
    heroDesc: "Upload one photo to generate opening suggestions, pacing cues, and risk alerts.",
    heroPrimary: "Find My Next Line",
    heroSecondary: "View Example",
    previewKicker: "EXAMPLE PREVIEW",
    previewTitle: "Client Communication",
    previewSummary: "First read: lower decision pressure first, then offer one clear and lightweight next step.",
    previewTraitsTitle: "Recommended opener",
    previewTagBoundary: "“I’m not trying to push this forward immediately. I’d mainly like to clarify the key options and risks for you; if convenient, I can walk through them in 10 minutes.”",
    previewTagExpression: "",
    previewTagExposure: "",
    previewTagObserve: "",
    ...
    previewFrameworkBigFive: "",
    previewFrameworkLanguage: "If they say “I’ve been busy,” reply: “I understand. I won’t take your time now. I’ll just send the most relevant point, and you can take a look whenever convenient.”",
    previewFrameworkPresentation: "",
    previewFrameworkAvatar: "",
    previewFrameworkSocial: "Communication Guidance",
    previewCurrentReadTitle: "Current Read",
    previewCurrentRead: "Good for low-pressure follow-up. Avoid pushing for a decision; offer one clear, low-cost next step first.",
    previewStrategyTitle: "Recommended Strategy",
    previewStrategy: "Lead with value, then suggest one small action.",
    previewOpenerTitle: "Recommended Opener",
    previewOpener: "“I’m not trying to push this forward immediately. I’d mainly like to clarify the two key options and risks for you; if convenient, I can walk through them in 10 minutes.”",
    previewNextMoveTitle: "Next Move",
    previewNextMove1: "Send one low-interruption message",
    previewNextMove2: "Offer a clear but lightweight next step",
    previewNextMove3: "Leave room for them to respond",
    previewRisk: "Risk alert: do not push them to decide immediately.",
    ...
    avatarUploadDesc: "Upload one clear photo to begin.",
