...
const translations = {
  zh: {
    ...
    analysisWaitingCuePresentation: "靠近信号",
    analysisWaitingCueStrategy: "开场建议",
    loadingTitle: "正在生成你的靠近建议",
    loadingDesc: "请稍等几秒，系统正在整理第一眼信号、靠近信号与开场建议。",
    ...
    visualTitle: "关系靠近面板",
    visualDesc: "分析完成后，系统将在这里展示第一眼信号、靠近信号、推荐开场和低压回复策略。",
  ...
  en: {
    ...
    logoutButton: "Exit",
    heroEyebrow: "FACE PHOTO · COMMUNICATION PROFILE",
    heroTitleLine1: "EVERY DISPLAY",
    heroTitleLine2: "IS A SIGNAL",
    heroDesc: "Upload one photo and turn public signals into a usable opening strategy",
    ...
    visualDesc: "Once analysis is complete, this area shows the first signal, approach signals, recommended opening, and low-pressure reply strategy.",
